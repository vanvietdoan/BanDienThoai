					...
					<div class="col-lg-8 col-12">
						<div class="checkout-form">
							...
							<!-- Form -->
								...
								<input name=proceedToCheckout type="submit" class="btn" value="proceed to checkout">
						</form>
							<!--/ End Form -->
						</div>
					</div>
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget">
								...
								<div class="content">
									<ul>
										<li>Sub Total<span>$<%=order.getTotalPrice() %></span></li>
										<li>(+) Shipping<span>$0</span></li>
										<li class="last">Total<span>$<%=order.getTotalPrice() %></span></li>
									</ul>
								</div>
							</div>
							<%
 							...
 							<h2>CART  TOTALS</h2>
								<div class="content">
									<ul>
										<li>Sub Total<span>0</span></li>
										<li>(+) Shipping<span>$0</span></li>
										<li class="last">Total<span>$0</span></li>
									</ul>
								</div>
 							<%
								}
