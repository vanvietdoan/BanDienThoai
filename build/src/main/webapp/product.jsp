...
=======
									...
									<% 
					            		ArrayList<ProductBean> listProduct2 = (ArrayList<ProductBean>)request.getAttribute("listP");
					           			for (ProductBean product : listProduct2) {    
					       			 %>
										<div class= "col-12 col-md-6 col-lg-4">
											<img class="default-img" src="images/<%= product.getImageUrl() %>" alt="#">
							               <%--  <img class="hover-img" src="images/<%= product.getImageUrl() %>" alt="#"> --%>
											<div class="card-body">
												<h4 class ="card-title show_txt"><%=product.getName() %></h4>
												<p class="card-text show_txt"><%=product.getManufacturer()%></p>
